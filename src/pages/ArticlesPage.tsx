        ...
        <div className="glass-card p-12 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex items-center justify-center space-x-3 mb-6">
              ...
              <h2 className="text-3xl font-bold text-white">Under Construction</h2>
            </div>
            <p className="text-white/80 text-xl">
              We're working hard to bring you valuable articles and resources. Check back soon for expert insights on eye care and medication management.
            </p>
          </div>
        </div>
      </div>
